    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(3) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoChatTable.equals(_existingChatTable)) {
          return new RoomOpenHelper.ValidationResult(false, "ChatTable(com.chat_soon_e.re_chat.data.entities.Chat).\n"
                  + " Expected:\n" + _infoChatTable + "\n"
                  + " Found:\n" + _existingChatTable);
        }
        ...
        if (! _infoUserTable.equals(_existingUserTable)) {
          return new RoomOpenHelper.ValidationResult(false, "UserTable(com.chat_soon_e.re_chat.data.entities.User).\n"
                  + " Expected:\n" + _infoUserTable + "\n"
                  + " Found:\n" + _existingUserTable);
        }
        ...
        if (! _infoOtherUserTable.equals(_existingOtherUserTable)) {
          return new RoomOpenHelper.ValidationResult(false, "OtherUserTable(com.chat_soon_e.re_chat.data.entities.OtherUser).\n"
                  + " Expected:\n" + _infoOtherUserTable + "\n"
        ...
        if (! _infoFolderTable.equals(_existingFolderTable)) {
          return new RoomOpenHelper.ValidationResult(false, "FolderTable(com.chat_soon_e.re_chat.data.entities.Folder).\n"
                  + " Expected:\n" + _infoFolderTable + "\n"
        ...
        if (! _infoFolderContentTable.equals(_existingFolderContentTable)) {
          return new RoomOpenHelper.ValidationResult(false, "FolderContentTable(com.chat_soon_e.re_chat.data.entities.FolderContent).\n"
        ...
        if (! _infoChatListTable.equals(_existingChatListTable)) {
          return new RoomOpenHelper.ValidationResult(false, "ChatListTable(com.chat_soon_e.re_chat.data.entities.ChatList).\n"
                  + " Expected:\n" + _infoChatListTable + "\n"
        ...
        if (! _infoIconTable.equals(_existingIconTable)) {
          return new RoomOpenHelper.ValidationResult(false, "IconTable(com.chat_soon_e.re_chat.data.entities.Icon).\n"
                  + " Expected:\n" + _infoIconTable + "\n"
                  + " Found:\n" + _existingIconTable);
        }
