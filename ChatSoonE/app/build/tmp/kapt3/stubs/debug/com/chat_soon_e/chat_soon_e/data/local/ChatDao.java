...
public abstract interface ChatDao {
    ...
    public abstract androidx.lifecycle.LiveData<java.util.List<com.chat_soon_e.chat_soon_e.data.entities.ChatList>> getRecentChat(long userIdx);
    ...
    public abstract androidx.lifecycle.LiveData<java.util.List<com.chat_soon_e.chat_soon_e.data.entities.ChatList>> getOneChatList(long userIdx, int chatIdx);
    ...
    public abstract androidx.lifecycle.LiveData<java.util.List<com.chat_soon_e.chat_soon_e.data.entities.ChatList>> getOrgChatList(long userIdx, int chatIdx);
