...
//  private lateinit var contentBinding: ActivityMainBinding
    ...
    private fun initRecyclerView() {
        ...
        mainRVAdapter = MainRVAdapter(chatList, isSelectionMode, this)
...
//                mainRVAdapter.toggleItemSelected(position)
    ...
    private fun initDrawerLayout() {
        ...
        binding.mainNavigationView.menu.getItem(0).setActionView(R.layout.layout_switch)
        val switch=binding.mainNavigationView.menu.getItem(0).actionView.findViewById<Switch>(R.id.switch_id)
...
//        }
        ...
        switch.setOnClickListener {
            if(!permissionGrantred()&&permission==false) { // 허용이 안 되어 있는 경우
                ...
                permission=true
            } else if(permissionGrantred()&&permission==true){    // 허용이 되어있는 겨웅
                switch.isChecked=false
                startActivity(Intent("android.settings.ACTION_NOTIFICATION_LISTENER_SETTINGS"))
                if(!permissionGrantred(this))
